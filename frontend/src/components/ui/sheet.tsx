  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-white fixed z-50 flex flex-col shadow-lg',
...
function SheetTitle(
  ...
  return (
    <SheetPrimitive.Title data-slot="sheet-title" className={cn('text-[#1F2937] font-semibold', className)} {...props} />
  )
}
...
function SheetDescription(
  ...
  return (
    <SheetPrimitive.Description data-slot="sheet-description" className={cn('text-gray-600 text-sm', className)} {...props} />
  )
}
