    ...
    <div className="min-h-screen bg-linear-to-br from-[#4F46E5] via-[#7C3AED] to-[#EC4899] flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-8 shadow-2xl border-0">
        <div className="text-center">
          {/* Logo */}
          <div className="w-20 h-20 bg-linear-to-br from-[#4F46E5] to-[#10B981] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
            <span className="text-white text-3xl font-bold">₹</span>
          </div>

          {/* Title */}
          <h1 className="text-3xl font-bold text-[#1F2937] mb-2">Welcome to FinPath</h1>
